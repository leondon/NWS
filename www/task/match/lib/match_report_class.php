			...
			switch ($op_result ['task']) {
				case 1:
					if($this->_task_obj->_task_status == 2){
						...
						db_factory::execute ( sprintf ( " update %switkey_finance set site_profit='%.2f' where obj_id='%d' and fina_type='out' and fina_action='pub_task'", TABLEPRE, $this->_task_info ['hirer_deposit'], $this->_task_obj->_task_id ) );
