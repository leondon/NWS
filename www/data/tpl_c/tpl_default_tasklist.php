<?php keke_tpl_class::checkrefresh('tpl/default/tasklist', '1414417562' );?><!DOCTYPE HTML>
...
<div class="actions">
      <a href="javascript:void(0);" class="tool-bar-item" data-toggle="dropdown" ><?php if($arrProvinces[$p]['name']) { ?><?php echo $arrProvinces[$p]['name']?><?php } else { ?>所在地区<?php } ?> <span class="caret"></span></a>
      <ul class="dropdown-menu for-city" role="menu" aria-labelledby="dLabel" >
