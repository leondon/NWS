<?php keke_tpl_class::checkrefresh('task/tender/tpl/default/step3', '1414479349' );?><div class="release-statistics">
        <h2 class="statistics-title">订单详细</h2>
        <div class="statistics-body">

            <div class="panel-heading">
              <h3 class="panel-title">
                  <div class="pull-right">网站服务费：<span class="money"><sub>￥</sub><?php echo $arrPubInfo['txt_task_cash'];?></span></div>
