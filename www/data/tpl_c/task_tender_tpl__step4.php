<?php keke_tpl_class::checkrefresh('task/tender/tpl/default/step4', '1414479530' );?>      <div class="release-form">
      	<?php if(!$status) { ?>
          <p class="lead text-center text-success mt_20"><i class="fa fa-check-circle"></i> 感谢，您的任务订单已提交，支付网站服务费之后用户才能投稿！<a href="index.php?do=task&id=<?php echo $taskId;?>" target="_blank">查看任务</a></p>
