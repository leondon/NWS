<?php keke_tpl_class::checkrefresh('task/preward/tpl/default/step2', '1414474954' );?><div class="release-form">
...
<option value="<?php echo $v['indus_id'];?>" <?php if($arrPubInfo['indus_id'] == $v['indus_id']) { ?> selected="selected"<?php } ?>><?php echo $v['indus_name'];?></option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <textarea id="tar_content" name="tar_content"  rows="10" placeholder="需求描述" class="form-control xheditor-simple {urlBase:'<?php echo $_K['siteurl']?>/',html5Upload:false,upImgUrl:'index.php?do=ajax&view=upload&file_type=att&filename=filedata',skin:'nostyle'}"><?php echo $arrPubInfo['tar_content'];?></textarea>
            </div>
            <div class="col-sm-3">
