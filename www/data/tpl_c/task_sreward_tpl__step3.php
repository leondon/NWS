<?php keke_tpl_class::checkrefresh('task/sreward/tpl/default/step3', '1414467418' );?><div class="release-statistics">
        ...
        <div class="statistics-body">
            ...
            <div class="panel-body ">
                ...
                <div class="release-detail">
                	...
                	<div id="partContent" class="ws_break <?php if(!$strPartComment) { ?>  hidden <?php } ?>">
                		<?php echo $strPartComment;?>
                	</div>
                	<div id="fullContent"  class="ws_break <?php if($strPartComment) { ?>hidden<?php } ?>">
