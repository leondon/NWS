<?php keke_tpl_class::checkrefresh('admin/tpl/admin_crawl_cn4', '1412415554' );?><!DOCTYPE HTML>
...
<div id="append_parent"></div> 
 ...
 <div class="page_title">
    	<h1><?php echo $_lang['crawl_task'];?></h1>
          <div class="crawl">          
<a href="index.php?do=crawl&view=cn4" <?php if($view == 'cn4') { ?>class="here"<?php } ?> ><?php echo $_lang['cn4'];?></a>
