<?php keke_tpl_class::checkrefresh('admin/tpl/admin_article_list', '1412416692' );?><!DOCTYPE HTML>
...
<div class="page_title">	
    	<h1><?php if($type=='art') { ?><?php echo $_lang['article'];?><?php } elseif($type=='help') { ?><?php echo $_lang['help'];?><?php } elseif($type=='bulletin') { ?><?php echo $_lang['bulletin'];?><?php } elseif($type=='about') { ?><?php echo $_lang['about'];?><?php } else { ?><?php echo $_lang['single_page'];?><?php } ?><?php echo $_lang['manage'];?></h1>
         <div class="tool">
            <a href="index.php?do=<?php echo $do?>&view=list&type=<?php echo $type?>" <?php if($view=='list') { ?>class="here" <?php } ?>>文章列表</a>
            <a href="index.php?do=<?php echo $do?>&view=edit&type=<?php echo $type?>" <?php if($view=='edit') { ?>class="here" <?php } ?>>添加文章</a>
    	</div>
</div>
    <!--页头结束-->
...
<?php if($v['is_recommend']==1&&$type !='help') { ?> [<?php echo $_lang['recommend'];?>]<?php } ?>
...
<a href="<?php if($type=='art') { ?>../index.php?do=article&id=<?php echo $v['art_id'];?>&page=<?php echo $page;?><?php } elseif($type=='help') { ?>../index.php?do=help&spid=<?php echo $v['art_cat_id'];?>&page=<?php echo $page;?><?php } else { ?>../index.php?do=single&id=<?php echo $v['art_id'];?><?php } ?>" target="_blank" class="button"><span class="book icon"></span><?php echo $_lang['view'];?></a> 
...
<a href="<?php echo $url?>&art_id=<?php echo $v['art_id']?>&ac=del&page=<?php echo $page;?>"  onclick="return cdel(this);" class="button"><span class="trash icon"></span><?php echo $_lang['delete'];?></a>
  ...
  <tfoot>
                  <tr>
                    <td colspan="7">
                    <div class="clearfix">
                        <label for="checkbox" onclick="checkall(event);"><?php echo $_lang['select_all'];?></label><!-- 全选 -->
