<?php keke_tpl_class::checkrefresh('task/preward/tpl/default/index', '1414477929' );?><!DOCTYPE HTML>
...
<?php } } ?>
          ...
          <div class="detail-obj">
            <div class="detail-obj-item">
              <div class="method">
              	<a href="index.php?do=tasklist&m=<?php echo $arrTaskInfo['model_id'];?>" class="method-type"  data-toggle="popover" data-placement="bottom" data-html="true" data-trigger="hover" data-content='方案中标发放赏金，所需稿件<?php echo $arrTaskInfo['work_count'];?>个，<br/>稿件单价<?php  echo keke_curren_class::output(floatval($arrTaskInfo[real_cash]/$arrTaskInfo[work_count]),-1);  ?>，已交稿件<?php echo $arrTaskInfo['work_num'];?>个，<br/>已中标<?php echo $intBidCount;?>个'><?php echo $arrModelInfo['model_name'];?>模式 <i class="fa fa-angle-down"></i></a>
