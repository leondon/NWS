<?php keke_tpl_class::checkrefresh('admin/tpl/admin_crawl_jp3', '1414414654' );?><!DOCTYPE HTML>
...
<div id="append_parent"></div> 
 ...
 <div class="page_title">
    	<h1><?php echo $_lang['crawl_task'];?></h1>
          <div class="crawl">          
<a href="index.php?do=crawl&view=jp3" <?php if($view == 'jp3') { ?>class="here"<?php } ?> ><?php echo $_lang['jp3'];?></a>
