<?php keke_tpl_class::checkrefresh('tpl/default/error', '1414417058' );?><!DOCTYPE HTML>
...
<div class="alert alert-danger">
    ...
    <hr>
     ...
     <p>如您的浏览器不能跳转，您可以 <a class="alert-link" href="javascript:history.go(-1);void(0);">返回上一页</a>  或点击 <a class="alert-link" <?php if($url) { ?>href="<?php echo $url;?>"<?php } else { ?>href="index.php"<?php } ?>>这里</a></p>
</div>
<div class="footer">
  <div class="container">
      <?php if($do=='index') { ?>
