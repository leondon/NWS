<?php keke_tpl_class::checkrefresh('task/dtender/tpl/default/step1', '1414479726' );?><div class="release-form">
...
<input type="hidden" name="txt_task_cash" value="<?php echo $arrConfig['deposit'];?>">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <div class="input-group date form_date ">
          ...
          <input id="txt_task_day" name="txt_task_day" class="form-control form_datetime" size="16" type="datetime" value="<?php echo $strMaxDay;?>" placeholder="结束日期" data-date="<?php echo $strMinDate;?>" data-date-format="yyyy-mm-dd">
        </div>
      </div>
    </div>
