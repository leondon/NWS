<?php keke_tpl_class::checkrefresh('task/dtender/tpl/default/step3', '1414479902' );?><div class="release-statistics">
        <h2 class="statistics-title">订单详细</h2>
        <div class="statistics-body">

            <div class="panel-heading">
              <h3 class="panel-title">
                  <div class="pull-right">赏金：<span class="money"><sub></sub><?php  echo keke_curren_class::output(floatval($arrCashCove[$arrPubInfo['task_cash_cove']]['start_cove']),-1);  ?>-<sub></sub><?php  echo keke_curren_class::output(floatval($arrCashCove[$arrPubInfo['task_cash_cove']]['end_cove']),-1);  ?></span></div>
