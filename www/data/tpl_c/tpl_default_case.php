<?php keke_tpl_class::checkrefresh('tpl/default/case', '1412671373' );?><!DOCTYPE HTML>
...
<div class="case">
      <div class="tab tab-darken">
        <a href="<?php echo $strUrl;?>&t=1" <?php if($t == '1') { ?>class="selected"<?php } ?>>任务案例</a>
       <a href="<?php echo $strUrl;?>&t=2" <?php if($t == '2') { ?>class="selected"<?php } ?>>商品案例</a>
      </div>
  ...
  <div class="list list-img">
    ...
    <?php if(is_array($arrCaseLists)) { foreach($arrCaseLists as $k => $v) { ?>
        ...
        <div class="list-item-img">
          <a href="<?php echo $v['objurl'];?>" title="<?php echo $v['case_title'];?>">
            <img	alt="<?php echo $v['case_title'];?>"  class="lazy" src="tpl/default/img/grey.gif"  data-original="<?php echo keke_shop_class::output_pics($v['case_img'],210,1); ?>">
          </a>
        </div>
        <a href="<?php echo $v['objurl'];?>" class="list-title" title="<?php echo $v['case_title'];?>">
          <span class="marked <?php echo $v['labelstyle'];?>"><?php echo $v['label'];?></span> <?php echo $v['case_title'];?>
        </a>
        <div class="list-item-footer">
          <strong class="money"><sub>￥</sub><?php echo $v['case_price'];?></strong>
          <span class="nums">
            <?php echo $v['text'];?>：<?php echo $v['amount'];?> <?php echo $v['quantifier'];?>
          </span>
          <span class="poster">
           <?php echo $v['from'];?>：<a href="<?php echo $v['fromurl'];?>"><?php echo $v['username'];?></a>
          </span>
        </div>
       </li>
  <?php } } ?>
...
<?php } ?>
  ...
  <div class="list-page">
    <div class="page-tips pull-left">
      显示 <?php echo $strPages['st'];?>~<?php echo $strPages['en'];?> 项 共 <?php echo $intCount;?> 个<?php if($t=='1') { ?>任务<?php } else { ?>商品<?php } ?>
    </div>
