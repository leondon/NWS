<?php keke_tpl_class::checkrefresh('task/sreward/tpl/default/index', '1414472164' );?><!DOCTYPE HTML>
...
data-html="true" data-trigger="hover" data-content="单人中标,威客中标后将得到：<?php  echo keke_curren_class::output(floatval($floatCash),-1);  ?>"><?php echo $arrModelInfo['model_name'];?>模式 <i class="fa fa-angle-down"></i></a>
...
<?php if($arrTaskInfo['task_status'] ==11||$arrTaskInfo['task_status'] ==13) { ?>
<?php if($k <= 6) { ?>
action
<?php } ?>
<?php } else { ?>
...
<?php } ?>
          ...
          <div class="step-text step-bottom">
            <p><strong class="step-title"><?php echo $v['desc'];?><?php if(($arrTaskInfo['task_status'] ==13||$arrTaskInfo['task_status'] ==11)&&$v['status']==6) { ?>(交付冻结)<?php } ?></strong></p>
...
<!-- container end -->
<script type="text/javascript" src="static/js/model/task/common.js" charset="<?php echo CHARSET;?>"></script>
<script type="text/javascript">
var uid = '<?php echo $uid;?>';
var taskId = '<?php echo $id;?>';
var username = "<?php echo $gUserInfo['username'];?>";
