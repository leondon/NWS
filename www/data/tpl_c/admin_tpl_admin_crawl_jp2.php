<?php keke_tpl_class::checkrefresh('admin/tpl/admin_crawl_jp2', '1414509236' );?><!DOCTYPE HTML>
...
<div id="append_parent"></div> 
 ...
 <div class="page_title">
    	<h1><?php echo $_lang['crawl_task'];?></h1>
          <div class="crawl">          
<a href="index.php?do=crawl&view=jp2" <?php if($view == 'jp2') { ?>class="here"<?php } ?> ><?php echo $_lang['jp2'];?></a>
