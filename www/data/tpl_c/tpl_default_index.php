...
<div class="category-list">
      <a href="javascript:void(0);" class="category-title"><i class="fa fa-list-ul"></i> 任务 <i class="fa fa-angle-down"></i></a>
...
<a href="<?php echo $v['event']['url']?>" title="<?php echo $v['event']['content']?>"><?php if($v['event']['cash']) { ?><span class="money"><sub>￥</sub><?php echo $v['event']['cash']?></span><?php } ?> <?php echo $v['event']['content']?> </a>
</p>
</li>
<?php } } ?>
</ul>
...
<div class="category-list">
      <a href="javascript:void(0);" class="category-title"><i class="fa fa-list-ul"></i> 商品 <i class="fa fa-angle-down"></i></a>
      <ul class="category-down">
...
<a title="<?php echo $arrCaseLists['0']['case_title'];?>" class="home-case-first-title" href="javascript:void(0);">
                  <span class="marked marked-task"><?php echo $model_list[$arrCaseLists['0']['model_id']]['model_name'];?></span> <?php echo $arrCaseLists['0']['case_title'];?>
                </a>
                <p><?php if($arrCaseLists['0']['obj_type']=='task') { ?>赏金<?php } else { ?>售价<?php } ?>：<span class="money">￥<?php echo $arrCaseLists['0']['case_price'];?></span></p>
                <p>发布人：<a href="index.php?do=seller&id=<?php echo $arrCaseLists['0']['uid']?>"><?php echo $arrCaseLists['0']['username']?></a></p>
                <!-- <p>雇主评价：原本不是这个vi色系，但是没有办法，因为上面的人非要用...</p> -->
                <p><?php if($arrCaseLists['0']['obj_type']=='task') { ?>投稿：<?php echo $arrCaseLists['0']['work_num'];?><?php } else { ?>售出：<?php echo $arrCaseLists['0']['sale_num'];?><?php } ?> 个</p>
</div>
...
<li>
<p class="record-list-title">
<span class="time"><?php echo date('m-d',$v['pub_time']); ?></span>
