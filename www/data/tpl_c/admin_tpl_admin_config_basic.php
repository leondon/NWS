<?php keke_tpl_class::checkrefresh('admin/tpl/admin_config_basic', '1412416689' );?><!DOCTYPE HTML>
...
<div class="box post">
        <div class="tabcon">
        	<div class="title"><h2><?php if($op == 'info') { ?><?php echo $_lang['website_config'];?><?php } elseif($op == 'conf') { ?><?php echo $_lang['basic_config'];?><?php } elseif($op == 'seo') { ?>SEO配置<?php } ?><span ><a href="#" style="font-size:small;"><?php if($op == 'seo') { ?>查看相关教程<?php } ?></a></span></h2>
</div>
            <div class="detail">
...
<br/>&nbsp;&nbsp;<?php echo $_lang['site_name_description'];?>
         ...
         <th scope="row">
                ...
                <td>
                    ...
                    <input type="hidden" name = "web_logo" id="web_logo" value="<?php echo $config_arr['web_logo']?>">
 <img id="logo_img" src="../<?php echo $config_arr['web_logo'];?>" <?php if(!$config_arr['web_logo']) { ?>class="hidden"<?php } ?> width="210px;" height="65px;">
                    <div class="c999">
                        <?php echo $_lang['support_img_type'];?>
                    </div>
&nbsp;&nbsp;LOGO建议大小：<?php echo $_lang['height'];?>65px <?php echo $_lang['width'];?>210px <?php echo $_lang['map_type'];?>:jpeg,gif,png,jpg
    ...
    <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea cols="50" name="stats_code" msg="<?php echo $_lang['third_party_code_statistics'];?><?php echo $_lang['length'];?>3-500" msgArea="txt_stats_code_msg" rows="3" class="textarea"><?php echo stripslashes($config_arr['stats_code']); ?></textarea>
...
<tr>
 ...
 <tr>
                ...
                <td>
                    ...
                    <span id="task_seo_title_msg"></span>
                </td>
            </tr>
<tr>
                <th scope="row">
 ...
 <tr>
                ...
                <td>
                    ...
                    <span id="goods_seo_title_msg"></span>
                </td>
            </tr>
<tr>
                <th scope="row">
 ...
 <tr>
                ...
                <td>
                    ...
                    <span id="seller_seo_title_msg"></span>
                </td>
            </tr>
<tr>
                <th scope="row">
 ...
 <tr>
                ...
                <td>
                    ...
                    <span id="case_seo_title_msg"></span>
                </td>
            </tr>
<tr>
                <th scope="row">
 ...
 <tr>
                ...
                <td>
                    ...
                    <span id="article_seo_title_msg"></span>
                </td>
            </tr>
<tr>
                <th scope="row">
...
<script src="../static/js/uploadify/jquery.uploadify.min.js" type="text/javascript">
        </script>
