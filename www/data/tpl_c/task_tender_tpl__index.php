<?php keke_tpl_class::checkrefresh('task/tender/tpl/default/index', '1414480191' );?><!DOCTYPE HTML>
    ...
    <div class="detail-header">
        ...
        <div class="detail-ctrl">
              ...
              <?php if($arrProcess_can['work_hand']&&$gUid) { ?>
                <a href="index.php?do=taskhandle&op=quote&taskId=<?php echo $arrTaskInfo['task_id'];?>" class="btn btn-primary btn-lg">我要交稿</a>
              <?php } ?>
...
data-html="true" data-trigger="hover" data-content="雇主选择中标者后，交付将在线下完成，雇主确认后，任务完成"><?php echo $arrModelInfo['model_name'];?>模式 <i class="fa fa-angle-down"></i></a>
        ...
        <li class="step-item <?php if($arrTaskInfo['task_status']>=$v['status']) { ?> action <?php } ?>">
          ...
          <div class="step-text step-top">
            <?php if($arrTaskInfo['task_status'] ==$v['status']) { ?>
            	...
            	<p><span class="red d_time" ed="<?php echo $v['timeing'];?>" ></span></p>
             <?php } ?>
          </div>
          <?php } ?>
        </li>
