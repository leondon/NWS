<?php keke_tpl_class::checkrefresh('admin/tpl/admin_user_add', '1412416781' );?><!DOCTYPE HTML>
...
<tbody>
  ...
  <tr>
                        ...
                        <td> <input type="text" class="txt" style="width:260px;" name="fds[phone]" id="phone" value="<?php echo $member_arr['phone'];?>" limit="required:false;type:mobileCn" title="请填写正确的电话号码" msg="请填写正确的电话号码" msgArea="pwd_tel_msg"  class="input_t"/><span id="pwd_tel_msg"></span>
</td>
                      </tr>
 ...
 <?php } ?>
  ...
  <tr>
                        ...
                        <td> <input name="fds[birthday]" onclick="showcalendar(event, this, 0)" size="30" name="fds[birthday]" id="birthday" value="<?php echo $member_arr['birthday'];?>" type="text" id="txt_task_day"   msgArea="span_task_day" onkeyup="clearstr(this)"
   	              limit="" msg="<?php echo $_lang['task_round_msg'];?>" max="" class="txt" style="width:260px;"/> 
